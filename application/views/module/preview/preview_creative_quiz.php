                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                    ...
                                    <div class="panel-body tab-slide-relative">
                                        <div class="tab-slide-view" id="tab_slide_view" style="display: none;">
                                            ...
                                            <?php $i = 1;
                                            foreach ($question_info['sentence'] as $sentence) { ?>
                                            ...
                                            <div class="col-md-10" style="padding: 0px;">
                                                <div class="ss_pagination">
                                                    <div>
                                                        ...
                                                        <button class="btn_work" style="color: #4c4a4a;background:#fff;border: none; padding: 2px;font-weight: 500;font-size: 13px;" type="button" id="prevBtn1" onclick="nextPrev_1(-999)">Previous</button>
                                                        ...
                                                        <button type="button" style="color: #4c4a4a;background:#fff;border: none; padding: 2px;font-weight: 500;font-size: 13px;" class="btn_work" id="nextBtn1" onclick="nextPrev_1(99999)">Next</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    // var paragraph_order = <?php if (isset($question_info['paragraph_order'])) {
                                    echo json_encode($question_info['paragraph_order']);
                                } else { ?> [] <?php } ?>;
