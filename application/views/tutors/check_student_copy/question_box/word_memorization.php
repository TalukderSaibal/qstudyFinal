        ...
        <div class="col-sm-10">
                  <?php 
                    ...
                    foreach($questions as $question){
                        ...
                        $ans = '&nbsp;<span style="color:#fb8836;font-size:20px;text-decoration:underline;line-height: 18px;line-height: 18px;">'.$student_ans[$i].'</span>&nbsp;';
                    ...
                    <div style="display:flex" class="question_all">
                        <div style="width:100%;background-color: #0000000f;padding: 15px;font-size:20px;"><?=$make_question?></div>
