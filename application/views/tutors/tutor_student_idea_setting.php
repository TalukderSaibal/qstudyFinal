    ...
    <div class="col-md-5" style="margin-left:2%;">
      ...
      <div class="standard_marking_box" style="display:none;">
        ...
        <div class="others_student_idea_menu" style="display:none;">
            ...
            <a type="button" style="padding: 6px 5px;" class="btn btn-select other_creative_button">Creative Sentence</a>
            ...
            <div class="other_title_menu" style="display:none;padding: 5px;">
              ...
              <div class="" style="display:flex;margin-top: 25px;">
                  ...
                  <div class="title_hint_parrent">
                      <textarea class="form-control title_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="1" data-id="2">Most of the student voted</textarea>
              ...
              <a type="button" class="title_set_option" data-id="2"><img src="assets/images/question_write.png" style="width:50px;height: 50px;"></a>
                  ...
                  <div class="title_hint_parrent">
                      <textarea class="form-control title_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="2"  data-id="1">Not Bad</textarea>
              ...
              <a type="button" class="title_set_option" data-id="3"><img src="assets/images/question_write.png" style="width:50px;height: 50px;"></a>
                  ...
                  <div class="title_hint_parrent">
                      <textarea class="form-control title_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="3" data-id="3">Very Closed</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
              ...
              <div class="" style="display:flex;margin-top: 25px;">
                  ...
                  <div class="title_hint_parrent">
                      <textarea class="form-control title_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="4" data-id="4">Not Really Story</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
...
<script>
  ...
  function call_tutor_idea_question(param) {
    ...
    if (tutor_ans != '') {
      ...
      // var get_sentences_original = new_sentense.slice(1);
      ...
      $('.student_idea_main').html(get_sentences_original);
