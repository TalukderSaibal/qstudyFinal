                              ...
                              ?>
                                 ...
                                 foreach ($student_ideas as $student_idea) {
                                    ...
                                    <li style="position:relative;<?php if ($k > 2) {
                                       ...
                                       <a class="view_student_idea idea_start_action" style="background: white; color:black;padding: 5px;border: 1px solid #ddd7d7;" href="javascript:;" data-index="<?= $student_idea['user_id']; ?>" data-question="<?= $student_idea['question_id']; ?>" data-idea="<?= $student_idea['id']; ?>">
                                          <div style="min-height:27px">
                                          <?php if($student_idea['idea_publish'] == 1){ ?>
                                                <img src="assets/images/hand_with_pen_icon.png" class="" style="height:25px;margin-left: 10px;">
                                          <?php } ?>
                                          </div>
                                          Idea-<?= $k; ?>
                                       </a>
      ...
      <div class="modal-content">
         ...
         <div class="btm_word_limt">
            ...
            <div style="text-align:center;margin:10px 0px;">
               <button type="button" id="idea_next_student" style="display:none;background-color:#ffc90e;border:1px solid black;" class="btn btn_nexts">Next</button>
               <button type="button" id="idea_next_close" style="display:none;background-color:#b5e61d;border:1px solid black;" class="btn btn_nexts" data-dismiss="modal">Close</button>
            </div>
...
<div class="modal fade ss_modal in" data-keyboard="false" data-backdrop="static" id="idea_title_show" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
   <div class="modal-dialog" role="document">
         ...
         <div class="btm_word_limt">
            <div style="border:1px solid #c3c3c3;margin: 0px 25%;">
               <h6 style="text-align:center;font-weight:bold;color:#7f7f7f;">Tutor<h6>
                     <p class="idea_tutor_name" style="text-align:center;font-weight:bold;color:#7f7f7f;">
                     <p>
                        <br>
                     <p style="text-align:center;font-weight:bold;">Idea/Topic/Story Title
                     <p>
            ...
            <div style="margin: 0px 23%;" class="student_point_check">
               <h6 style="text-align:center;font-weight:bold;color:#880015;">Choose Your Marking<h6>
                     ...
                     <br>
                     <p style="text-align:center;font-weight:bold;color:#7f7f7f;">See others tutor's "Idea" and then submit
                     <p>
            </div>
   ...
   <div style="max-width: 100%;margin-top:8%;" class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <div style="padding:10px;" class="btm_word_limt p-3">
            ...
            <form id="add_profile_form" method="post" enctype="multipart/form-data">
               <div>
                  ...
                  <div class="row p-3">
                     <div class="col-sm-6">
                        <div class="form-group">
                           <label>Name</label>
                           <input type="text" id="student_name" class="form-control" value="<?php if (empty($profile2)) {
                                                                                                echo $profile[0]['name'];
                                                                                             } else {
                                                                                                echo $profile2[0]['name'];
                                                                                             } ?>" name="student_name">
                        </div>
                        <div class="form-group">
                           <label>School Name <a href="#">Optional</a></label>
                           <input type="text" id="school_name" class="form-control" value="<?php if (empty($profile2)) {
                                                                                                echo $profile[0]['school_name'];
                                                                                             } else {
                                                                                                echo $profile2[0]['school_name'];
                                                                                             } ?>" name="school_name">
                        </div>
                        <div class="form-group">
                           <label>Country</label>

                           <input type="text" id="country" class="form-control" value="<?php if (empty($profile2)) {
                                                                                          echo $profile[0]['countryName'];
                                                                                       } else {
                                                                                          echo $profile2[0]['country'];
                                                                                       } ?>" name="country">
                        </div>
                     </div>
                     <div class="col-sm-6">
                        <div class="text-center">
                           <div class="form-group">
                              ...
                              <label><i class="fa fa-cloud-upload" aria-hidden="true"></i></label>
                              <br>
                              <label style="cursor:pointer;" for="file-input">Chose Photo to Upload</label>
                              <p><a type="button">(Optional)</a></p>
                           </div>
                           <div class="image_box"><img style="height:100px;" id="imgFrame" src="<?php if (!empty($profile2[0])) {
                                                                                                   echo "assets/uploads/profile/thumbnail/" . $profile2[0]['profile_image'];
                                                                                                } else {
                                                                                                   echo "assets/images/default_user.jpg";
...
<script type="text/javascript">
   <?php if ($creative_course_status == 0) { ?>
      ...
      function countdown() {
         ...
         if (parseInt(i.innerHTML) <= 0) {
            ...
            alert('You need to Purchase "Creative Writting" to continue this writting.');
            commonCall();
   ...
   $("#idea_start").on("click", function() {
      ...
      <?php if ($profile2[0]['user_id'] == '') { ?>
         ...
         <?php } else {
         if ($idea_info[0]['student_title'] == 1) { ?>
      ...
      $.ajax({
         ...
         success: function(data) {
            ...
            if (idea_info.idea_publish == 1) {
               $('#idea_next_student').show();
               $('#idea_next_close').hide();
            } else {
               $('#idea_next_close').show();
               $('#idea_next_student').hide();
            }
            ...
            if (tutor_ans != '') {
               ...
               for (var i = 0; i < get_sentences.length; i++) {
                  ...
                  var get_new_sentense = get_new_sentense.filter(function(e) {
                     return e.replace(/(\r\n|\n|\r)/gm, "")
                  });
