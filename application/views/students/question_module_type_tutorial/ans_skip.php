            ...
            <div class="ss_s_b_main" style="min-height: 100vh">
                <form id="answer_form">
                    ...
                    <div class="col-md-8">
                        ...
                        <?php if (questionBody) : ?>
                            <div style="font-weight:bold;font-size:16px;margin-left: 3px;"><?= $questionBody ?></div>
                        <?php endif; ?>
...
foreach ($total_question as $ind) {
    if ($ind['question_video'] != '' && $ind['question_video'] != "[]") { ?>
        ...
        <div class="modal fade in" data-keyboard="false" data-backdrop="static" id="ss_question_video<?php echo $i; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-keyboard="false">
...
<script>
    ...
    function showQuestionVideo(id) {
        ...
        $("body").delegate(".active_video_play", "click", function() {
            alert('aaaaaaaaa');
        });
    }
