    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div style="text-align:center;">
               ...
               <img src="assets/images/hand_with_pen_icon.png" class="examine_button_show" style="height:25px;margin-left: 10px;display:none">
            </div>
        ...
        $(document).on('click','.idea_publish',function(){
            ...
            if($(this).is(':checked')){
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if(response==1){
                            $('.examine_button').attr('style','background-color:#c3c3c3;border-radius:0px;');
                            $('.examine_button_show').hide();
                        }
