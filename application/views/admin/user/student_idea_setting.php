...
<div class="" style="margin-left: 15px;">
  ...
  <input type="hidden" id="creative_colors">
 ...
 <form action="" id="given_idea_point">
  ...
  <input type="hidden" name="st_title_text" id="st_title_text">
  <input type="hidden" name="st_spelling_text" id="st_spelling_text">
  <input type="hidden" name="st_creative_text" id="st_creative_text">
  <input type="hidden" name="st_introduction_text" id="st_introduction_text">
  <input type="hidden" name="st_body_paragraph_text" id="st_body_paragraph_text">
  <input type="hidden" name="st_conclusion_text" id="st_conclusion_text">
  ...
  <input type="hidden" name="creative_sentence_color" id="creative_sentence_color">
  ...
  <div class="other_student_value">
    ...
    <input type="hidden" name="other_title_student_ans" id="other_title_student_ans">
    ...
    <input type="hidden" name="other_metaphor_text" id="other_metaphor_text">
    ...
    <div class="col-md-5" style="margin-left:2%;">
      <div class="row standard_selected_box" style="margin-left:1px;margin-bottom:50px;display:none;">
        <div style="display:flex;gap:20px;">
            <a class="students_button idea_student" type="button"><?=$student_idea[0]['name']?></a>
      ...
      <div class="standard_marking_box" style="display:none;">
        ...
        <div class="student_idea_menu" style="display:none;">
            <a type="button" class="btn btn-select title_button" 
            <?= $idea_correction['total_title_mark'] ? 'style="background-color:#00A2E8;padding: 6px 8px;"':'' ?> >Title</a>
            <a type="button" class="btn btn-select spelling_error"
            <?= $idea_correction['total_spelling_mark'] ? 'style="background-color:#00A2E8;padding: 6px 8px;"':'' ?> >Spelling Error</a>
            <a type="button" class="btn btn-select creative_sentence"
            <?= $idea_correction['creative_sentence_mark'] ? 'style="background-color:#00A2E8;padding: 6px 8px;"':'' ?> >Mataphor</a>
          
            <a type="button" class="btn btn-select introduction_button" style="padding: 6px 10px;">Introduction</a>
            <a type="button" class="btn btn-select body_paragraph_button" style="padding: 6px 10px;">Body Paragraph</a>
            <a type="button" class="btn btn-select conclution_button" style="padding: 6px 10px;">Conclution</a>
            <a type="button" class="btn btn-select story_structure" style="padding: 6px 10px;">Story Structure</a>
        </div>

        <div class="others_student_idea_menu" style="display:none;">
            <a type="button" style="padding: 6px 5px;" class="btn btn-select other_title_button">Title</a>
            <a type="button" style="padding: 6px 5px;" class="btn btn-select other_image_button">Image</a>
            <a type="button" style="padding: 6px 5px;" class="btn btn-select other_spelling_error">Spelling Error</a>
            <a type="button" style="padding: 6px 5px;" class="btn btn-select other_creative_button">Mataphor</a>
            <a type="button" style="padding: 6px 5px;" class="btn btn-select other_story_structure_button">Story Structure</a>
        </div>
        
        <div class="others_story_structure_menu" style="display:none;">
             <a type="button" class="btn btn-select other_introduction_button" style="padding: 6px 10px;">Introduction</a>
             <a type="button" class="btn btn-select other_body_paragraph_button" style="padding: 6px 10px;">Body Paragraph</a>
             <a type="button" class="btn btn-select other_conclution_button" style="padding: 6px 10px;">Conclution</a>
  ...
  <div class="row" style="padding:0px 15px; display: flex;">
    <div class="col-md-6" style="border: 1px solid #82bae6;padding: 5px;box-shadow: 0px 0px 4px #82bae6;border-radius: 5px;">
      ...
      <div class="student_idea_main">
      <?= $student_idea[0]['idea_ans']; ?>
      </div>
      
      <div class="student_idea_text" style="display:none;">
        <?= $student_idea[0]['idea_ans']; ?>
      </div>
        ...
        <div class="main_student_idea">
          ...
          <div class="title_menu" style="display:none;">
            ...
            <div class="text-center">
                <img class="add_title_text" src="assets/images/images/question_write.png" style="width: 35px;cursor:pointer;">
            </div>
          ...
          <div class="spelling_error_menu" style="display:none">
            ...
            <br><br>
            <div class="text-center">
                <img class="add_spelling_text" src="assets/images/images/question_write.png" style="width: 35px;cursor:pointer;">
            </div>
          ...
          <div class="creative_sentence_show">
              <div style="text-align:center;">
                <a class="btn btn-danger">Mataphor</a>
              </div>
              <br><br>
              <div class="text-center">
                  <img class="add_creative_text" src="assets/images/images/question_write.png" style="width: 35px;cursor:pointer;">
              </div>
              <div style="margin-top:30px;display:flex;justify-content:center;">
                  <h5>Your Point : </h5>
                  <input type="text" class="form-control total_creative_sentence_point" style="color:#2b2b2f;width:50px;height:30px;background-color:white;" value="0">
              </div>
              <br>
              <br>
              <div style="text-align:center;">
          ...
          <div class="introduction_menu" style="display:none;">
            ...
            <br><br>
            <div class="text-center">
                <img class="add_introduction_text" src="assets/images/images/question_write.png" style="width: 35px;cursor:pointer;">
            </div>
            <div style="margin-top:30px;background-color:#f7f7f7;display:flex;justify-content:center;">
                <h5 >Your Point : </h5>
          ...
          <div class="body_paragraph_menu" style="display:none;">
            ...
            <br><br>
            <div class="text-center">
                <img class="add_body_paragraph_text" src="assets/images/images/question_write.png" style="width: 35px;cursor:pointer;">
            </div>
            <div style="margin-top:30px;background-color:#f7f7f7;display:flex;justify-content:center;">
                <h5 style="">Your Point : </h5>
          ...
          <div class="conclution_menu" style="display:none;">
            <div style="text-align:center;">
              <a class="btn btn-danger">Conclusion</a>
            </div>
            <br>
            ...
            <br><br>
            <div class="text-center">
                <img class="add_conclusion_text" src="assets/images/images/question_write.png" style="width: 35px;cursor:pointer;">
            </div>
            <div style="margin-top:30px;background-color:#f7f7f7;display:flex;justify-content:center;">
                <h5 style="">Your Point : </h5>
        ...
        <div class="others_student_idea">
            <div class="other_title_menu" style="display:none;padding: 5px;">
              <div style="border:1px solid #dbdbdb;padding:3px;font-weight:bold;">
                  <p>Do you think <b><?=$student_idea[0]['name']?></b> story "Title" could have been better ? If it seems so which of these "Title" would you choose from bellow?</p>
              </div>
              <br>
              <div class="other_title_box" style="display:flex;margin-top: 25px;">
                  <a type="button" class="title_set_option" data-id="1"><img class="title_set_option_icon1" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  ...
                  <div class="title_hint_parrent">
                      <div style="text-align:right;position:relative;">
                        <select class="form-control title_option title_option1" data-id="1">
                          <option value="">--Select One--</option>
                          <option value="Most of the student voted">Most of the student voted</option>
                          <option value="Not Bad">Not Bad</option>
                          <option value="Very Closed">Very Closed</option>
                          <option value="Not Related Story">Not Related Story</option>
                        </select>
                        <i class="fa fa-bars title_options" aria-hidden="true" data-id="1"></i>
                      </div>
                      <textarea class="form-control title_hint_sort title_hint_sort1" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="1" data-id="2">Not Bad</textarea>
              ...
              <div class="other_title_box" style="display:flex;margin-top: 25px;">
                  <a type="button" class="title_set_option" data-id="2"><img class="title_set_option_icon2" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom "></span>
                  </label>
                  <div class="title_hint_parrent">
                  <div style="text-align:right;position:relative;">
                        <select class="form-control title_option title_option2" data-id="2">
                          <option value="">--Select One--</option>
                          <option value="Most of the student voted">Most of the student voted</option>
                          <option value="Not Bad">Not Bad</option>
                          <option value="Very Closed">Very Closed</option>
                        ...
                        <i class="fa fa-bars title_options" aria-hidden="true" data-id="2"></i>
                      </div>
                      <textarea class="form-control title_hint_sort title_hint_sort2" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="2"  data-id="1">Most of the student voted</textarea>
              ...
              <div class="other_title_box" style="display:flex;margin-top: 25px;">
              <a type="button" class="title_set_option" data-id="3"><img class="title_set_option_icon3" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom "></span>
                  </label>
                  <div class="title_hint_parrent">
                      <div style="text-align:right;position:relative;">
                        <select class="form-control title_option title_option3" data-id="3">
                          <option value="">--Select One--</option>
                          <option value="Most of the student voted">Most of the student voted</option>
                          <option value="Not Bad">Not Bad</option>
                          <option value="Very Closed">Very Closed</option>
                        ...
                        <i class="fa fa-bars title_options" aria-hidden="true" data-id="3"></i>
                      </div>
                      <textarea class="form-control title_hint_sort title_hint_sort3" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="3" data-id="3">Very Closed</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
              ...
              <div class="other_title_box" style="display:flex;margin-top: 25px;">
                  <a type="button" class="title_set_option" data-id="4"><img class="title_set_option_icon4" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom "></span>
                  </label>
                  <div class="title_hint_parrent">
                      <div style="text-align:right;position:relative;">
                        <select class="form-control title_option title_option4" data-id="4">
                          <option value="">--Select One--</option>
                          <option value="Most of the student voted">Most of the student voted</option>
                          <option value="Not Bad">Not Bad</option>
                          <option value="Very Closed">Very Closed</option>
                        ...
                        <i class="fa fa-bars title_options" aria-hidden="true" data-id="4"></i>
                      </div>
                      <textarea class="form-control title_hint_sort title_hint_sort4" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="4" data-id="4">Not Related Story</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
            ...
            <div class="other_title_menu_preview_box" style="padding: 15px;display:none;">
                <p style="font-weight:bold;">Do you think <b><?=$student_idea[0]['name']?></b> story "Title" could have been better ? If it seems so which of these "Title" would you choose from bellow?</p>
                ...
                <div style="margin-top: 15px;margin-left: 10px;">
                    <label class="custom_radio"><span class="hint_set_prev hint_set_prev1" class="title_opt_hint1"></span><i class="fa fa-share title_opt_hint_icon title_opt_hint_icon1" style="color:#ecd3b8;" aria-hidden="true"></i><span class="title_opt_prev1 all_options"></span>
                      <input type="radio" class="radio_ans" id="html" name="other_title" value="1">
                ...
                <div style="margin-top: 15px;margin-left: 10px;">
                    <label class="custom_radio"><span class="hint_set_prev hint_set_prev2" class="title_opt_hint2"></span><i class="fa fa-share title_opt_hint_icon title_opt_hint_icon2" style="color:red;" aria-hidden="true"></i><span class="title_opt_prev2 all_options"></span>
                      <input type="radio" class="radio_ans" id="html" name="other_title" value="2">
                      <span class="checkmark checkmark2"></span>
                    </label>
                </div>
                <div style="margin-top: 15px;margin-left: 10px;">
                    <label class="custom_radio"><span class="hint_set_prev hint_set_prev3" class="title_opt_hint3"></span><i class="fa fa-share title_opt_hint_icon title_opt_hint_icon3" style="color:#ecd3b8;" aria-hidden="true"></i><span class="title_opt_prev3 all_options"></span>
                      <input type="radio" class="radio_ans" id="html" name="other_title" value="3">
                ...
                <div style="margin-top: 15px;margin-left: 10px;">
                    <label class="custom_radio"><span class="hint_set_prev hint_set_prev4" class="title_opt_hint4"></span><i class="fa fa-share title_opt_hint_icon title_opt_hint_icon4" style="color:#ecd3b8;" aria-hidden="true"></i><span class="title_opt_prev4 all_options"></span>
                      <input type="radio" class="radio_ans" id="html" name="other_title" value="4">
            ...
            <div class="other_image_menu" style="padding: 5px;display:none;">
                <p style="font-weight:bold;">Which Photo best descrive for <b><?=$student_idea[0]['name']?>'s</b> story ?</p>
                <div class="row">
                    <div class="col-md-6" style="display:flex;">
                        <div>
                          ...
                          <a type="button" class="image_set_option" data-id="1">
                            <img class="image_set_option_icon1" src="assets/images/images/question.png" style="width: 40px;height: 40px;margin-top: 30px;"></a>
                          <div style="height:30px;width:30px;border:1px solid #a9a8a8;margin-top: 7px;">
                              <select class="image_point image_point1 select-hidden" data-id="1" style="width: 28px;height: 28px;">
                                <option value=""></option>
                    ...
                    <div class="col-md-6" style="display:flex;">
                        <div>
                          ...
                          <a type="button" class="image_set_option" data-id="2">
                            <img class="image_set_option_icon2" src="assets/images/images/question.png" style="width: 40px;height: 40px;margin-top: 30px;"></a>
                          
                          <div style="height:30px;width:30px;border:1px solid #a9a8a8;margin-top: 7px;">
                              <select class="image_point image_point2" data-id="2" style="width: 28px;height: 28px;">
                                <option value=""></option>
                                <option value="0">0</option>
                                <option value="10">10</option>
                                <option value="15">15</option>
                    ...
                    <div class="col-md-6" style="display:flex;">
                        <div>
                          ...
                          <a type="button" class="image_set_option" data-id="3">
                            <img class="image_set_option_icon3" src="assets/images/images/question.png" style="width: 40px;height: 40px;margin-top: 30px;"></a>
                          
                          <div style="height:30px;width:30px;border:1px solid #a9a8a8;margin-top: 7px;">
                              <select class="image_point image_point3" data-id="3" style="width: 28px;height: 28px;">
                                <option value=""></option>
                                <option value="0">0</option>
                                <option value="10">10</option>
                                <option value="15">15</option>
                    ...
                    <div class="col-md-6" style="display:flex;">
                        <div>
                          ...
                          <a type="button" class="image_set_option" data-id="4">
                            <img class="image_set_option_icon4" src="assets/images/images/question.png" style="width: 40px;height: 40px;margin-top: 30px;"></a>
                          
                          <div style="height:30px;width:30px;border:1px solid #a9a8a8;margin-top: 7px;">
                              <select class="image_point image_point4" data-id="4" style="width: 28px;height: 28px;">
                                <option value=""></option>
                                <option value="0">0</option>
                                <option value="10">10</option>
                                <option value="15">15</option>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                      ...
                      <div class="show_image_box_2" style="border:5px solid #a9a8a8;margin: 10px 10px 10px 40px;width:185px;height: 150px;position:relative;">
                           <div class="right_box"><p class="right_box_text"></p><img class="right_arrow" src="assets/images/down_arrow.png"></div>
            ...
            <div class="other_spelling_error_menu" style="padding:10px;display:none;">
              <div style="text-align:center;">
                <h6>Click and choose the words from <b><?=$student_idea[0]['name']?></b>'s story which was mis spelled.</h6>
              </div>
              <br>
              <br>
            ...
            <div class="other_creative_sentence_menu" style="padding:10px;display:none;">
              <div style="text-align:center;">
                <h6>Click and choose 2 sentences from <b><?=$student_idea[0]['name']?></b>'s story that represents mataphors Example of metaphor.</h6>
              </div>
              <p class="extra_metaphor_box_show" style="margin-top:10px;text-align:center"></p>
              <br>
              <br>
                <textarea class="form-control other_creative_sentence_input_box" style="height:80px;color: #00a2f0;"></textarea>
                <div class="other_creative_sentence_show_box" style="min-height:100px;width:100%;border:1px solid #d2d2d2;padding:10px;display:none"></div>
              <br>
              <br>
              <div style="text-align:left;">
              <div style="display:flex;gap:10px;">
            ...
            <div class="other_ss_introduction_menu" style="display:none;padding: 5px;">
              <div style="border:1px solid #dbdbdb;padding:3px;font-weight:bold;">
                  <p>Do you think <b><?=$student_idea[0]['name']?></b> story "Introduction" could have been better ? If it seems so which of these "Paragraph" would you choose from bellow?</p>
              </div>
              <br>
              <div class="" style="display:flex;margin-top: 25px;">
                  <a type="button" class="set_option" data-id="1"><img class="introduction_set_option_icon1" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom"></span>
                  </label>
                  <div class="introduction_hint_parrent">
                      <textarea class="form-control introduction_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="1" data-id="2">Most of the student voted</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
                    <input type="text" class="form-control" style="width:50px;margin-left: 15px;height: 55px;font-weight:bold;" value="10">
              ...
              <div class="" style="display:flex;margin-top: 25px;">
              <a type="button" class="set_option" data-id="2"><img class="introduction_set_option_icon2" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom "></span>
                  </label>
                  <div class="introduction_hint_parrent">
                      <textarea class="form-control introduction_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="2"  data-id="1">Not Bad</textarea>
                      <!-- <textarea class="form-control title_hint_sort" style="width: 330px;color: #9d9a9a;font-weight:bold;"  data-id="2">Most of the student voted</textarea> -->
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
              ...
              <div class="" style="display:flex;margin-top: 25px;">
              <a type="button" class="set_option" data-id="3"><img class="introduction_set_option_icon3" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom "></span>
                  </label>
                  <div class="introduction_hint_parrent">
                      <textarea class="form-control introduction_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="3" data-id="3">Very Closed</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
                    <input type="text" class="form-control" style="width:50px;margin-left: 15px;height: 55px;font-weight:bold;" value="15">
              ...
              <div class="" style="display:flex;margin-top: 25px;">
                  <a type="button" class="set_option" data-id="4"><img class="introduction_set_option_icon4" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom "></span>
                  </label>
                  <div class="introduction_hint_parrent">
                      <textarea class="form-control introduction_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="4" data-id="4">Not Related Story</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
                    <input type="text" class="form-control" style="width:50px;margin-left: 15px;height: 55px;font-weight:bold;" value="0">
            ...
            <div class="other_ss_introduction_menu_preview_box" style="padding: 15px;display:none;">
                <p style="font-weight:bold;">Do you think <b><?=$student_idea[0]['name']?></b> story "Introduction" could have been better ? If it seems so which of these "Paragraph" would you choose from bellow?</p>
            ...
            <div class="other_body_paragraph_menu" style="display:none;padding: 5px;">
              <div style="border:1px solid #dbdbdb;padding:3px;font-weight:bold;">
                  <p>Do you think <b><?=$student_idea[0]['name']?></b> story "Body Paragraph" could have been better ? If it seems so which of these "Paragraph" would you choose from bellow?</p>
              </div>
              <br>
              <div class="" style="display:flex;margin-top: 25px;">
                  <a type="button" class="body_para_set_option" data-id="1"><img class="body_para_set_option_icon1" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom"></span>
                  </label>
                  <div class="body_paragraph_hint_parrent">
                      <textarea class="form-control body_paragraph_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="1" data-id="2">Most of the student voted</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
                    <input type="text" class="form-control" style="width:50px;margin-left: 15px;height: 55px;font-weight:bold;" value="10">
              ...
              <div class="" style="display:flex;margin-top: 25px;">
              <a type="button" class="body_para_set_option" data-id="2"><img class="body_para_set_option_icon2" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom "></span>
                  </label>
                  <div class="body_paragraph_hint_parrent">
                      <textarea class="form-control body_paragraph_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="2"  data-id="1">Not Bad</textarea>
                      <!-- <textarea class="form-control title_hint_sort" style="width: 330px;color: #9d9a9a;font-weight:bold;"  data-id="2">Most of the student voted</textarea> -->
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
              ...
              <div class="" style="display:flex;margin-top: 25px;">
              <a type="button" class="body_para_set_option" data-id="3"><img class="body_para_set_option_icon3" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom "></span>
                  </label>
                  <div class="body_paragraph_hint_parrent">
                      <textarea class="form-control body_paragraph_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="3" data-id="3">Very Closed</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
                    <input type="text" class="form-control" style="width:50px;margin-left: 15px;height: 55px;font-weight:bold;" value="15">
              ...
              <div class="" style="display:flex;margin-top: 25px;">
                  <a type="button" class="body_para_set_option" data-id="4"><img class="body_para_set_option_icon4" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom "></span>
                  </label>
                  <div class="body_paragraph_hint_parrent">
                      <textarea class="form-control body_paragraph_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="4" data-id="4">Not Related Story</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
                    <input type="text" class="form-control" style="width:50px;margin-left: 15px;height: 55px;font-weight:bold;" value="0">
            ...
            <div class="other_ss_conclution_menu" style="display:none;padding: 5px;">
              <div style="border:1px solid #dbdbdb;padding:3px;font-weight:bold;">
                  <p>Do you think <b><?=$student_idea[0]['name']?></b> story "Conclusion" could have been better ? If it seems so which of these "Paragraph" would you choose from bellow?</p>
              </div>
              <br>
              <div class="" style="display:flex;margin-top: 25px;">
                  <a type="button" class="ss_conclution_set_option" data-id="1">
                    <img class="conclution_set_option_icon1" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom"></span>
                  </label>
                  <div class="ss_conclution_hint_parrent">
                      <textarea class="form-control ss_conclution_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="1" data-id="2">Most of the student voted</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
                    <input type="text" class="form-control" style="width:50px;margin-left: 15px;height: 55px;font-weight:bold;" value="10">
              ...
              <div class="" style="display:flex;margin-top: 25px;">
              <a type="button" class="ss_conclution_set_option" data-id="2">
                <img class="conclution_set_option_icon2" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom "></span>
                  </label>
                  <div class="ss_conclution_hint_parrent">
                      <textarea class="form-control ss_conclution_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="2"  data-id="1">Not Bad</textarea>
                      <!-- <textarea class="form-control title_hint_sort" style="width: 330px;color: #9d9a9a;font-weight:bold;"  data-id="2">Most of the student voted</textarea> -->
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
              ...
              <div class="" style="display:flex;margin-top: 25px;">
              <a type="button" class="ss_conclution_set_option" data-id="3">
                <img class="conclution_set_option_icon3" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom "></span>
                  </label>
                  <div class="ss_conclution_hint_parrent">
                      <textarea class="form-control ss_conclution_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="3" data-id="3">Very Closed</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
                    <input type="text" class="form-control" style="width:50px;margin-left: 15px;height: 55px;font-weight:bold;" value="15">
              ...
              <div class="" style="display:flex;margin-top: 25px;">
                  <a type="button" class="ss_conclution_set_option" data-id="4">
                    <img class="conclution_set_option_icon4" src="assets/images/images/question.png" style="width:50px;height: 50px;"></a>
                  <label class="custom_radio_custom">
                      <input type="radio" class="radio_ans" id="html" name="radio_ans" value="2" checked>
                      <span class="checkmark_custom "></span>
                  </label>
                  <div class="ss_conclution_hint_parrent">
                      <textarea class="form-control ss_conclution_hint_sort" style="width: 300px;color: #9d9a9a;font-weight:bold;" data-index="4" data-id="4">Not Related Story</textarea>
                  </div>
                  <div style="position:relative;">
                    <span style="position: absolute;color: #9d9a9a;margin-top: -20px;margin-left: 20px;">Point</span>
                    <input type="text" class="form-control" style="width:50px;margin-left: 15px;height: 55px;font-weight:bold;" value="0">
...
<div class="modal fade ss_modal" id="ss_sucess_mess" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="" class="btn btn_blue" id="save_success_button_with_url">Ok</a>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer option_footer">
        <button type="button" class="btn btn_blue image_options_modal_close" data-dismiss="modal">Save</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade ss_modal ew_ss_modal" id="title_options_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer option_footer">
        <button type="button" class="btn btn_blue title_options_modal_close">Save</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade ss_modal ew_ss_modal" id="intro_options_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer option_footer">
        <button type="button" class="btn btn_blue introduction_options_modal_close" data-dismiss="modal">Save</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade ss_modal ew_ss_modal" id="body_paragraph_options_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer option_footer">
        <button type="button" class="btn btn_blue body_para_options_modal_close" data-dismiss="modal">Save</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade ss_modal ew_ss_modal" id="body_ss_conclution_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer option_footer">
        <button type="button" class="btn btn_blue conclution_options_modal_close" data-dismiss="modal">Save</button>
      </div>
    </div>
  </div>
</div>
...
<div id="original_student_idea" style="display:none;">

</div>

<div class="modal fade ss_modal" id="title_text_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <!-- Modal -->
  <div style="max-width: 100%;margin-top:8%;" class="modal-dialog idea_box" role="document">
    <div class="modal-content">
      <div class="modal-body" style="background-color: #00A2E8;">
        <div style="position:relative;">
          <h6 style="text-align:center;">Title Text </h6>
          <button style="color:black;border:none;position:absolute;right:10px;top:1px;" type="button" class="close_ch close_large_question" data-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i></button>
        </div>
        <div class="row">
          <textarea spellcheck="false" id="title_text" class="form-control mytextarea" name="title_text"></textarea>
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn large_question_close" id="save_title_text">Save</button>
      </div>
    </div>
  </div>
</div>

<div class="modal fade ss_modal" id="spelling_text_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <!-- Modal -->
  <div style="max-width: 100%;margin-top:8%;" class="modal-dialog idea_box" role="document">
    <div class="modal-content">
      <div class="modal-body" style="background-color: #00A2E8;">
        <div style="position:relative;">
          <h6 style="text-align:center;">Spelling Text </h6>
          <button style="color:black;border:none;position:absolute;right:10px;top:1px;" type="button" class="close_ch close_large_question" data-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i></button>
        </div>
        <div class="row">
          <textarea id="spelling_text" class="form-control creativetextarea" name="spelling_text"></textarea>
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn large_question_close" id="save_spelling_text">Save</button>
      </div>
    </div>
  </div>
</div>

<div class="modal fade ss_modal" id="creative_text_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <!-- Modal -->
  <div style="max-width: 100%;margin-top:8%;" class="modal-dialog idea_box" role="document">
    <div class="modal-content">
      <div class="modal-body" style="background-color: #00A2E8;">
        <div style="position:relative;">
          <h6 style="text-align:center;">Creative Text </h6>
          <button style="color:black;border:none;position:absolute;right:10px;top:1px;" type="button" class="close_ch close_large_question" data-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i></button>
        </div>
        <div class="row">
          <textarea id="creative_text" class="form-control mytextarea" name="creative_text"></textarea>
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn large_question_close" id="save_creative_text">Save</button>
      </div>
    </div>
  </div>
</div>

<div class="modal fade ss_modal" id="introduction_text_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <!-- Modal -->
  <div style="max-width: 100%;margin-top:8%;" class="modal-dialog idea_box" role="document">
    <div class="modal-content">
      <div class="modal-body" style="background-color: #00A2E8;">
        <div style="position:relative;">
          <h6 style="text-align:center;">Introduction Text </h6>
          <button style="color:black;border:none;position:absolute;right:10px;top:1px;" type="button" class="close_ch close_large_question" data-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i></button>
        </div>
        <div class="row">
          <textarea id="introduction_text" class="form-control mytextarea" name="introduction_text"></textarea>
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn large_question_close" id="save_introduction_text">Save</button>
      </div>
    </div>
  </div>
</div>

<div class="modal fade ss_modal" id="body_paragraph_text_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <!-- Modal -->
  <div style="max-width: 100%;margin-top:8%;" class="modal-dialog idea_box" role="document">
    <div class="modal-content">
      <div class="modal-body" style="background-color: #00A2E8;">
        <div style="position:relative;">
          <h6 style="text-align:center;">Body Paragraph Text </h6>
          <button style="color:black;border:none;position:absolute;right:10px;top:1px;" type="button" class="close_ch close_large_question" data-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i></button>
        </div>
        <div class="row">
          <textarea id="body_paragraph_text" class="form-control mytextarea" name="body_paragraph_text"></textarea>
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn large_question_close" id="save_body_paragraph_text">Save</button>
      </div>
    </div>
  </div>
</div>

<div class="modal fade ss_modal" id="conclusion_text_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <!-- Modal -->
  <div style="max-width: 100%;margin-top:8%;" class="modal-dialog idea_box" role="document">
    <div class="modal-content">
      <div class="modal-body" style="background-color: #00A2E8;">
        <div style="position:relative;">
          <h6 style="text-align:center;">Conclusion Text </h6>
          <button style="color:black;border:none;position:absolute;right:10px;top:1px;" type="button" class="close_ch close_large_question" data-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i></button>
        </div>
        <div class="row">
          <textarea id="conclusion_text" class="form-control mytextarea" name="conclusion_text"></textarea>
        </div>
      </div>

      <div class="modal-footer">
        <button type="button" class="btn large_question_close" id="save_conclusion_text">Save</button>
      </div>
    </div>
  </div>
</div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    //alert($("#make_student_idea_title").find("p:first").text());
    var title_chk = $("#make_student_idea_title").find("p:first").text();
  
    var title_disable = 0;
    if(title_chk=='Idea/Topic/Story title'){
    ...
    $('.title_button').click(function() {
      ...
      var ttmark = '<?= $idea_correction['total_title_mark'] ? $idea_correction['total_title_mark'] : '' ?>';
      $('.total_title_point').val(ttmark);

      $(".student_marking").each(function(){
          let check = $(this).val();
          if (check == ttmark){
  ...
  function call_tutor_idea_question(param) {
    ...
    var tutor_ans = $('.student_idea_text').text();
    // console.log(tutor_ans);
    // alert(tutor_ans);
    /*===========new code=================*/
    if (tutor_ans != '') {
      
      var get_sentences_main = tutor_ans.split('\n');
      var get_sentences_original = tutor_ans;




      var get_original_student_ans = `<?=$student_idea[0]['idea_ans']?>`;
      $('#original_student_idea').html(get_original_student_ans);
      var title_chk = $("#original_student_idea").find("p:first").text();
      
      if(title_chk=='Idea/Topic/Story title'){
        var get_sentences_slice = get_sentences_main.slice(4);
      }else{
          var get_sentences_slice = get_sentences_main;
          $('.title_button').attr("disabled",true);
      }

      
      // var get_sentences = get_sentences_original;

      var get_sentences = get_sentences_slice.filter(function(e){
        var x = e.replace(/(\r\n|\n|\r)/gm,"");
        var y = x.replace(/"/g,'');
        if(y.trim().length<=0){
          return false;
      ...
      for (var i = 0; i < get_sentences.length; i++) {
        ...
        var aaaaaa= add_br+get_sentences[i];
        var get_sentence = aaaaaa.replace(/<[\/]{0,1}(p)[^><]*>/ig, "");
        ...
        var get_new_sentense = get_new_sentense.filter(function(e){ return e.replace(/(\r\n|\n|\r)/gm,"")});
        // console.log(get_new_sentense);
      ...
      for (k = 0; k < abc_arr.length; k++) {
        if(abc_arr[k] === '<br>'){
          spelling_answer += "<span style='flex:0 0 100%;'></span>";
        }else{
      ...
      for (k = 0; k < abc_arr.length; k++) {
        if(abc_arr[k] === '<br>'){
          other_spelling_answer += "<span style='flex:0 0 100%;'></span>";
        }else{
      ...
      for (k = 0; k < abc_arr.length; k++) {
        // if(abc_arr[k] === '<br> '){
        if(abc_arr[k] === '<br>'){
          other_spelling_answer_match += "<span style='flex:0 0 100%;'></span>";
        }else{
      ...
      for (k = 0; k < abc_arr.length; k++) {
        ...
        if(abc_arr[k] === '<br>'){
          all_answer += "<span style='flex:0 0 100%;'></span>";
        }else{
      ...
      var n;
      // console.log(sentense_store);
      for (n = 0; n < sentense_store.length; n++) {
        // console.log(sentense_store[n]);
        var make_new_sentence = sentense_store[n].split('<br>');
        // console.log(make_new_sentence);
        if(make_new_sentence.length==2){
          all_sentense_answer += '<br><span class="one_hint_wrap grammer_answer_new grammer_ans_new' + n + '" data-id="' + n + '">' + make_new_sentence[1] + '.</span>';
        }else{
          all_sentense_answer += '<span class="one_hint_wrap grammer_answer_new grammer_ans_new' + n + '" data-id="' + n + '">' + make_new_sentence[0] + '.</span>';
        }
      ...
      for (n = 0; n < sentense_store.length - 1; n++) {
        // other_creative_sentence += '<span class="one_hint_wrap other_creative other_creative' + n + '" data-id="' + n + '">' + sentense_store[n].trim() + '.</span>';
        var text = sentense_store[n].trim();
        // var text = sentense_store[n];
        var trim = text.replace(/<br\s*\/?>/gi,' ');

        other_creative_sentence += '<span class="one_hint_wrap other_creative other_creative' + n + '" data-id="' + n + '">' + trim + '.</span>';
      }
      ...
      // console.log(get_sentences);
      $('.student_idea_main').html(all_answer);
  ...
  $('.save_all_info').click(function(e){
      ...
      $.ajax({
        url: "Admin/teacher_idea_correction_update",
        method: "POST",
        ...
        success: function(data) {
          ...
          $("#ss_sucess_mess").modal('show');
            var pre_url = '<?=$_SERVER['HTTP_REFERER']?>';
            $('#save_success_button_with_url').attr('href',pre_url);
        }
      });
  });
  ...
  $('.spelling_error').click(function() {
    ...
    let spelling_error_value = '<?= $idea_correction['spelling_error_value']; ?>';
    let spelling_error_values = JSON.parse(spelling_error_value);


    $('.grammer_answer').each(function() {
        let text = $(this).attr('data-id');
        for(var i=0; i< spelling_error_values.length; i++){
          let word_index = spelling_error_values[i].word_index;
          let correct_words = spelling_error_values[i].correct_words;
          if (text == word_index){
              ...
              if (checkStyle == undefined) {
                ...
                $('.grammer_ans' + text).prepend('<i data-id="'+ text +'" style="cursor:pointer;margin-top: -58px;margin-left: -30px;color: red;position: absolute;font-size:14px;" class="fa fa-close spelling_remover"></i><input class="spelling_prepend spelling_prepend'+text+'" wordindex="' + text + '" style="margin-top: -42px;margin-left: -32px;color: #000;position: absolute;width: 106px;height: 35px;background-color: #FFFFFF;border: 1px solid #C5EB4E;" value="'+ correct_words +'">');
              }
          }
        }
    })

    let total_spelling_mark = '<?= $idea_correction['total_spelling_mark']; ?>';
    $('.total_splleing_error_point').val(total_spelling_mark);
  ...
  $(document).delegate('.grammer_answer', 'click', function() {
    ...
    if (checkStyle != undefined) {
      ...
      $('.grammer_ans' + text).attr('style', 'background-color: rgb(255, 201, 14); position: relative;');
      $('.grammer_ans' + text).prepend('<i data-id="'+ text +'" style="cursor:pointer;margin-top: -58px;margin-left: -30px;color: red;position: absolute;font-size:14px;" class="fa fa-close spelling_remover"></i><input class="spelling_prepend spelling_prepend'+text+'" wordindex="' + text + '" style="margin-top: -42px;margin-left: -32px;color: #000;position: absolute;width: 106px;height: 35px;background-color: #FFFFFF;border: 1px solid #C5EB4E;" value="">');
    }
  });
  ...
  $(document).delegate('.other_spelling', 'click', function() {
    ...
    if (checkStyle != undefined) {
      ...
      $('.other_spelling' + text).prepend('<i data-id="'+ text +'" style="cursor:pointer;margin-top: -58px;margin-left: -30px;color: red;position: absolute;font-size:14px;" class="fa fa-close other_spelling_remover"></i><input class="other_spelling_prepend other_spelling_prepend'+text+'" wordindex="' + text + '" style="margin-top: -42px;margin-left: -32px;color: #000;position: absolute;width: 106px;height: 35px;background-color: #FFFFFF;border: 1px solid #C5EB4E;" value="">');
    }
  });
  ...
  $(document).delegate('.other_spelling_error_save', 'click', function() {
      ...
      // console.log(other_spelling_ques_words);   
      // console.log(other_spellings);          
  ...
  var every_creative_sentense_color = new Array();
  ...
  $('.creative_sentence').click(function() {
      ...
      let creative_sentence_index = '<?= $idea_correction['creative_sentence_index']; ?>';
      let creative_indexs = creative_sentence_index.split(',');
      // console.log(creative_indexs);

      $('.grammer_answer_new').each(function() {

        for(var i=0; i< creative_indexs.length; i++){
          var id = $(this).attr('data-id');
          if (id == creative_indexs[i]){
            
            every_creative_sentense_index.push(creative_indexs[i]);

            var chk_ = $(this).attr('style');
            if(chk_ == undefined){
                var text = $(this).text();
                
                $('.grammer_ans_new' + id).attr('style', 'background-color: #ffc90e');
                $('.grammer_ans_new' + id).append('<span class="tooltip_one tooltip_rs">Metaphor</span>');
            }else{
                $(this).removeAttr('style');
      ...
      let creative_sentence_mark = '<?= $idea_correction['creative_sentence_mark']; ?>';
      $('.total_creative_sentence_point').val(creative_sentence_mark);
  ...
  $(document).delegate('.grammer_answer_new', 'click', function() {
    ...
    if(chk_ == undefined){
        ...
        var sentence_color = ['#ffc90e', '#54ef40', '#f549c9','#bee131','#7fdbe3','#dcef40','#ef8840'];

        var chk_color_index = $('#creative_colors').val();
        if(chk_color_index==''){
          $('#creative_colors').val(0);
        }else if(chk_color_index==6){
          $('#creative_colors').val(0);
        }else{
          var chk_color_index = parseInt(chk_color_index)+1;
          $('#creative_colors').val(chk_color_index);
        }
          var color_index = $('#creative_colors').val();
      
        $("#creative_sentence_index").val(every_creative_sentense_index);

        $('.grammer_ans_new' + id).attr('style', 'background-color: '+sentence_color[color_index]);
        every_creative_sentense_color.push(sentence_color[color_index]);

        $('.grammer_ans_new' + id).append('<span class="tooltip_one tooltip_rs">Metaphor</span>');

        $('#creative_sentence_color').val(every_creative_sentense_color);
        $('#creative_sentence_mark').val(creative_mark);
        $('.total_creative_sentence_point').val(creative_mark);
        // console.log(every_creative_sentense_index);
        // console.log(every_creative_sentense_color);
    }else{

        var id = $(this).attr('data-id');
        var text = $(this).text();
        var get_color = $(this).attr('style');

        $(this).removeAttr('style');

        var slice_array = sliceArray(id, every_creative_sentense_index);
        $("#creative_sentence_index").val(slice_array);
        
        every_creative_sentense_index = every_creative_sentense_index.filter(function(e,i) { 

          if(e !== id){
             return true;
          }else{
            every_creative_sentense_color.splice(i, 1);
            return false;
          }
          //return e !== id 
        });
  ...
  $(document).delegate('.other_creative', 'click', function() { 
    ...
    if(chk_ == undefined){
        ...
        if (other_creative_sentense_index.length > 10) {
          other_creative_sentense_index.pop();
          alert('You can not select more than 10 sentence');
          return false;
        }
        ...
        var back = ["rgb(232,14,225)","rgb(16,238,230)","rgb(238,16,82)","rgb(14,232,50)"];
        var rand = back[Math.floor(Math.random() * back.length)];

        $('.other_creative' + id).attr('style', 'background-color: '+rand+'');
        $('.other_creative' + id).append('<span class="tooltip_one tooltip_rs">Metaphor</span>');
        ...
        other_creative_sentense_index = other_creative_sentense_index.filter(function(e,i) { 
          if(e !== id){
             return true;
          }else{
            every_creative_sentense_color.splice(i, 1);
  ...
  $(document).delegate('.other_creative_match', 'click', function() {
    ...
    var attr = $('.other_creative_match' + id).attr('style');
    if (typeof attr !== 'undefined' && attr !== false) {
      $('.other_creative_match' + id).removeAttr('style');
    }else{
  ...
  $('.story_structure').click(function(e) {
      ...
      let introduction_point = "<?= $idea_correction['introduction_point']; ?>";
      let body_paragraph_point = "<?= $idea_correction['body_paragraph_point']; ?>";
      let conclusion_point = "<?= $idea_correction['conclusion_point']; ?>";
      if(introduction_point){
        $('.introduction_button').attr('style','background-color: rgb(0, 162, 232); padding: 6px 8px;');
      }
      
      if(body_paragraph_point){
        $('.body_paragraph_button').attr('style','background-color: rgb(0, 162, 232); padding: 6px 8px;');
      }

      if(conclusion_point){
        $('.conclution_button').attr('style','background-color: rgb(0, 162, 232); padding: 6px 8px;');
      }
  });
  ...
  $('.introduction_button').click(function(e) {
    ...
    var introduction_mark = '<?= $idea_correction['introduction_point']; ?>';
    $('.total_introduction_point').val(introduction_mark);

    $(".introduction_marking").each(function(){
        let mark = $(this).val();
        if (mark == introduction_mark){
            $(this).attr('checked', true);
        }
    });
  ...
  $(document).delegate('.grammer_answer_introduction', 'click', function() {
      var id = $(this).attr('data-id');
      var chk_intro = $(this).attr('style');
      if(chk_intro == undefined){
        every_introduction_sentense_index.push(id);
        if (every_introduction_sentense_index.length > 10) {
          every_introduction_sentense_index.pop();
          alert('You can not select more than ten sentence');
          return false;
        }
        ...
        // console.log(every_introduction_sentense_index);
      }else{
        $(this).removeAttr('style');
        var id = $(this).attr('data-id');
        
        every_introduction_sentense_index = every_introduction_sentense_index.filter(function(e,i) { 
          if(e !== id){
             return true;
          }else{
            // every_introduction_sentense_index.splice(i, 1);
            return false;
          }
          //return e !== id 
        });
  ...
  $('.body_paragraph_button').click(function(e){
      ...
      var body_paragraph_point = '<?= $idea_correction['body_paragraph_point']; ?>';
      $('.total_body_paragraph_point').val(body_paragraph_point);

      $(".body_paragraph_marking").each(function(){
          let mark = $(this).val();
          if (mark == body_paragraph_point){
              $(this).attr('checked', true);
          }
      });
  ...
  $(document).delegate('.grammer_answer_body ','click',function(){
    var id = $(this).attr('data-id');
    var chk_body_para = $(this).attr('style');
    if(chk_body_para == undefined){
        every_body_sentense_index.push(id);
        if (every_body_sentense_index.length > 15) {
            every_body_sentense_index.pop();
            alert('You can not select more than fifteen sentence');
            return false;
        }
        ...
        every_body_sentense_index = every_body_sentense_index.filter(function(e,i) { 
          if(e !== id){
            return true;
          }else{
            // every_body_sentense_index.splice(i, 1);
            return false;
          }
          //return e !== id 
        });
  ...
  $('.conclution_button').click(function(e) {
      ...
      var conclusion_point = '<?= $idea_correction['conclusion_point']; ?>';
      $('.total_conclution_point').val(conclusion_point);

      $(".conclution_marking").each(function(){
          let mark = $(this).val();
          if (mark == conclusion_point){
              $(this).attr('checked', true);
          }
      });
  ...
  $(document).delegate('.grammer_answer_news', 'click', function() {
      var id = $(this).attr('data-id');
      var chk_conclusion = $(this).attr('style');
      if(chk_conclusion == undefined){
          every_conclusion_sentense_index.push(id);
          if (every_conclusion_sentense_index.length > 10) {
          ...
          every_conclusion_sentense_index = every_conclusion_sentense_index.filter(function(e,i) { 
            if(e !== id){
              return true;
            }else{
              // every_body_sentense_index.splice(i, 1);
  ...
  $('.conclution_submit').click(function(e){
      ...
      if(title_mark != ''){
        ...
        ///  save student info shukriti
        var pre_url = '<?=$_SERVER['HTTP_REFERER']?>';
        
        var data=$("#given_idea_point").serialize();
        $.ajax({
          url: "Admin/teacher_idea_correction_save",
          method: "POST",
          enctype: 'multipart/form-data',
          data: data,
          cache: false,
  ...
  $('.idea_student').click(function(){
      ...
      $(this).attr('data-id',1);
      $('.student_idea_main').attr('style', 'display:none;');
      $('.student_idea_text').attr('style', 'display:block;');
  ...
  $('.idea_others_student').click(function(){
      ...
      let other_title_button = '<?= $idea_correction['title']; ?>';
      let other_image_button = '<?= $idea_correction['image']; ?>';
      let other_spelling_error_value = '<?= $idea_correction['other_spelling_error_value']; ?>';
      let other_creative_sentence_index = '<?= $idea_correction['other_creative_sentence_index']; ?>';

      let other_introduction_button = '<?= $idea_correction['ss_intro']; ?>';
      let other_body_paragraph_button = '<?= $idea_correction['ss_body']; ?>';
      let other_conclution_button = '<?= $idea_correction['ss_conclution']; ?>';

      if(other_title_button)$('.other_title_button').attr('style','background-color: rgb(0, 162, 232); padding: 6px 8px;');
      if(other_image_button)$('.other_image_button').attr('style','background-color: rgb(0, 162, 232); padding: 6px 8px;');
      if(other_spelling_error_value)$('.other_spelling_error').attr('style','background-color: rgb(0, 162, 232); padding: 6px 8px;');
      if(other_creative_sentence_index)$('.other_creative_button').attr('style','background-color: rgb(0, 162, 232); padding: 6px 8px;');

      if(other_introduction_button)$('.other_introduction_button').attr('style','background-color: rgb(0, 162, 232); padding: 6px 8px;');
      if(other_body_paragraph_button)$('.other_body_paragraph_button').attr('style','background-color: rgb(0, 162, 232); padding: 6px 8px;');
      if(other_conclution_button)$('.other_conclution_button').attr('style','background-color: rgb(0, 162, 232); padding: 6px 8px;');
  ...
  $('.other_title_button').click(function(){
      ...
      var other_std_title = '<?php echo $idea_correction['title']; ?>';
      var other_std_title_parse = JSON.parse(other_std_title);

      $('.title_set_option').each(function(){
        var id = $(this).attr('data-id');
        
        if(other_std_title_parse.title_option_one && id == 1){
          $('.title_set_option_icon'+id).attr('src','assets/images/question_write.png');
          $('#title_option_one_hint').val(other_std_title_parse.title_option_one_hint);
          $('#title_option_one').val(other_std_title_parse.title_option_one);
        }
        if(other_std_title_parse.title_option_two && id == 2){
          $('.title_set_option_icon'+id).attr('src','assets/images/question_write.png');
          $('#title_option_two_hint').val(other_std_title_parse.title_option_two_hint);
          $('#title_option_two').val(other_std_title_parse.title_option_two);
        }
        if(other_std_title_parse.title_option_three && id == 3){
          $('.title_set_option_icon'+id).attr('src','assets/images/question_write.png');
          $('#title_option_three_hint').val(other_std_title_parse.title_option_three_hint);
          $('#title_option_three').val(other_std_title_parse.title_option_three);
        }
        if(other_std_title_parse.title_option_four && id == 4){
          $('.title_set_option_icon'+id).attr('src','assets/images/question_write.png');
          $('#title_option_four_hint').val(other_std_title_parse.title_option_four_hint);
          $('#title_option_four').val(other_std_title_parse.title_option_four);
        }
        
        $('#other_title_student_ans').val('<?= $idea_correction['other_title_student_ans'] ?>');
      ...
      $('.option_all').each(function(){
        ...
        if(other_std_title_parse.title_option_one && id == 1)$('.option_description'+id).val(other_std_title_parse.title_option_one);
        if(other_std_title_parse.title_option_two && id == 2)$('.option_description'+id).val(other_std_title_parse.title_option_two);
        if(other_std_title_parse.title_option_three && id == 3)$('.option_description'+id).val(other_std_title_parse.title_option_three);
        if(other_std_title_parse.title_option_four && id == 4)$('.option_description'+id).val(other_std_title_parse.title_option_four);
  ...
  $('.other_title_menu_submit').click(function(){
      ...
      var st_ans = $("input[name='other_title']:checked").val();
      $('#other_title_student_ans').val(st_ans);

      $('.title_hint_sort').each(function(){
        var title_option_hint_val = $(this).val();
        var id = $(this).attr('data-id');
        var index = $(this).attr('data-index');
        // console.log('st_ans'+st_ans);
        // console.log('id'+id);
  ...
  $('.other_image_button').click(function(){
    ...
    var other_std_title = '<?= $idea_correction['image']; ?>';
    // var other_std_title = {"image_option_points":"0,10,15,20","image_option_ans":"1","option_one_image_texts":"[\"a\",\"b\",\"c\",\"d\"]"};
    // var other_std_title_parse = JSON.parse(other_std_title);
    // console.log(other_std_title);
    
    var image_points = new Array();
    var image_texts = new Array();

    $('.image_set_option').each(function(){
      var id = $(this).attr('data-id');

      var text_image = JSON.parse(other_std_title.option_one_image_texts);
      // console.log(text_image);

      if(text_image[0] && id == 1)$('.image_set_option_icon'+id).attr('src','assets/images/question_write.png');
      if(text_image[1] && id == 2)$('.image_set_option_icon'+id).attr('src','assets/images/question_write.png');
      if(text_image[2] && id == 3)$('.image_set_option_icon'+id).attr('src','assets/images/question_write.png');
      if(text_image[3] && id == 4)$('.image_set_option_icon'+id).attr('src','assets/images/question_write.png');
    });

    $('.image_option_all').each(function(i){
      var id = $(this).attr('data-id');

      var text_image = JSON.parse(other_std_title.option_one_image_texts);
      image_texts.push(text_image[i]);

      if(text_image[i] && id == 1)$('.image_option_description'+id).val(text_image[i]);
      if(text_image[i] && id == 2)$('.image_option_description'+id).val(text_image[i]);
      if(text_image[i] && id == 3)$('.image_option_description'+id).val(text_image[i]);
      if(text_image[i] && id == 4)$('.image_option_description'+id).val(text_image[i]);
    });
    ...
    $('.image_point').each(function(i){

      var id = $(this).attr('data-id');

      var image_option_ans = $('input[name="image_radio_option"]:checked').val();
      if(image_option_ans != undefined) $('#image_option_ans').val(image_option_ans);

      var image_check = other_std_title.image_option_points.split(',');
      image_points.push(image_check[i]);
      $('#image_option_points').val(image_points);

      if(image_check[i] && id == 1)$('.image_point'+id).val(image_check[i]);
      if(image_check[i] && id == 2)$('.image_point'+id).val(image_check[i]);
      if(image_check[i] && id == 3)$('.image_point'+id).val(image_check[i]);
      if(image_check[i] && id == 4)$('.image_point'+id).val(image_check[i]);

    });
    
    $('input[name="image_radio_option"]').each(function(){
      if($(this).val() == other_std_title.image_option_ans){
        $(this).attr('checked', true);
        $('#image_option_ans').val(other_std_title.image_option_ans);
      }
    });
    ...
    $('.image_option').each(function(){
      ...
      if(image_check[0] && id == 1)$('#upload_option_image_'+id).val(image_check[0]);
      if(image_check[1] && id == 2)$('#upload_option_image_'+id).val(image_check[1]);
      if(image_check[2] && id == 3)$('#upload_option_image_'+id).val(image_check[2]);
      if(image_check[3] && id == 4)$('#upload_option_image_'+id).val(image_check[3]);
    });
  ...
  $('.image_option').change(function(){
      ...
      $.ajax({
        url: "upload_idea_story_options_admin",
        method:'POST',
        data:form_data,
        contentType:false,
        cache:false,
  ...
  $('.title_set_option').click(function(){
      ...
      var other_std_title = '<?= $idea_correction['title']; ?>';
      var other_std_title_parse = JSON.parse(other_std_title);

      if(id == 1){
        $('.option_description' + id).val(other_std_title_parse.title_option_one);
        // $('.title_hint_sort'+id).val(other_std_title_parse.title_option_one_hint);
      }
      if(id == 2){
        $('.option_description' + id).val(other_std_title_parse.title_option_two);
        // $('.title_hint_sort'+id).val(other_std_title_parse.title_option_two_hint);
      }
      if(id == 3){
        $('.option_description' + id).val(other_std_title_parse.title_option_three);
        // $('.title_hint_sort'+id).val(other_std_title_parse.title_option_three_hint);
      }
      if(id == 4){
        $('.option_description' + id).val(other_std_title_parse.title_option_four);
        // $('.title_hint_sort'+id).val(other_std_title_parse.title_option_four_hint);
      }

      $('#title_options_modal').modal('show');
      $('.title_options_modal_close').attr('data-id',id);
  });

  $('.title_options_modal_close').click(function(){
      var id = $(this).attr('data-id');
      $('.title_set_option_icon'+id).attr('src','assets/images/question_write.png');
      $('#title_options_modal').modal('hide');
  });

  //introduction question box color change
  $('.set_option').click(function(){
      var id = $(this).attr('data-id');
      $('.ss_intro_option_all').hide(); 
      $('.ss_intro_option_description' + id).show();
      $('#intro_options_modal').modal('show');
      $('.introduction_options_modal_close').attr('data-id',id);
  });

  $('.introduction_options_modal_close').click(function(){
      var id = $(this).attr('data-id');
      $('.introduction_set_option_icon'+id).attr('src','assets/images/question_write.png');
      $('#intro_options_modal').modal('hide');
  });

  //body para question box color change
  $('.body_para_set_option').click(function(){
      ...
      $('.body_para_options_modal_close').attr('data-id',id);
  });
  $('.body_para_options_modal_close').click(function(){
      var id = $(this).attr('data-id');
      $('.body_para_set_option_icon'+id).attr('src','assets/images/question_write.png');
      $('#body_paragraph_options_modal').modal('hide');
  });

  //conclution question box color change
  $('.ss_conclution_set_option').click(function(){
    ...
    $('.conclution_options_modal_close').attr('data-id',id);
  });

  $('.conclution_options_modal_close').click(function(){
      var id = $(this).attr('data-id');
      $('.conclution_set_option_icon'+id).attr('src','assets/images/question_write.png');
      $('#body_ss_conclution_modal').modal('hide');
  });
  //image question box color change
  $('.image_set_option').click(function(){
      var id = $(this).attr('data-id');
      $('.image_option_all').hide(); 
      $('.image_option_description' + id).show();
      $('#image_options_modal').modal('show');
      $('.image_options_modal_close').attr('data-id',id);
  });
  $('.image_options_modal_close').click(function(){
      var id = $(this).attr('data-id');
      $('.image_set_option_icon'+id).attr('src','assets/images/question_write.png');
      $('#image_options_modal').modal('hide');
  });
  ...
  $('.other_spelling_error').click(function(){
    ...
    let other_spelling_error_value = '<?= $idea_correction['other_spelling_error_value']; ?>';
    let other_spelling_error_values = JSON.parse(other_spelling_error_value);
    console.log(other_spelling_error_values);


    $('.other_spelling').each(function() {
        let text = $(this).attr('data-id');
        for(var i=0; i< other_spelling_error_values.length; i++){
          let word_index = other_spelling_error_values[i].word_index;
          let correct_words = other_spelling_error_values[i].correct_words;
          if (text == word_index){
              var checkStyle = $(this).attr('style');
              if (checkStyle == undefined) {

                $('.other_spelling' + text).attr('style', 'background-color: rgb(255, 201, 14); position: relative;');
                $('.other_spelling' + text).prepend('<i data-id="'+ text +'" style="cursor:pointer;margin-top: -58px;margin-left: -30px;color: red;position: absolute;font-size:14px;" class="fa fa-close other_spelling_remover"></i><input class="other_spelling_prepend other_spelling_prepend'+text+'" wordindex="' + text + '" style="margin-top: -42px;margin-left: -32px;color: #000;position: absolute;width: 106px;height: 35px;background-color: #FFFFFF;border: 1px solid #C5EB4E;" value="'+ correct_words +'">');
  ...
  $('.other_spelling_error_submit').click(function(){
      ...
      // if(right_words != ''){
        ...
        for(var i=0;i<spelling_wrong_words.length;i++){
          var wrong_index = spelling_wrong_words[i];
          console.log(wrong_index);

          if(jQuery.inArray(wrong_index, spelling_right_words) == -1) {
              
              console.log(wrong_index);
            
              var text = wrong_index;
              var get_word = $('.other_spelling_match' + text).text();
              var word_no = $('.spelling_error_words').length;
              var word_no = word_no+1;
              var words = '<p style="position:relative;margin-top: 15px;" class="spelling_error_words spelling_error_words'+text+'"><i class="fa fa-close spell_word_wrong'+text+'" style="font-size:24px;color:red;position:absolute; top: -17px;left: 25px;display:none;"></i><i class="fa fa-check spell_word_right'+text+'" style="font-size:24px;color:green;position:absolute;top: -17px;left: 25px;display:none;"></i><i class="fa fa-exclamation creative_sentence_wrong'+text+'" style="font-size:22px;color:#00a2e8;position:absolute; top: -17px;left: 30px;"></i><span>'+word_no+'.</span>'+get_word+'<span id="correction_info'+text+'"></span></p>';
                
              $('.other_spelling_error_words').append(words);

              $('#correction_info'+wrong_index).html('<b style="margin-left:20px;color:#00A2E8;">(Not Choosen)</b>');
  ...
  $('.other_creative_button').click(function(){
    ...
    let other_creative_sentence_index = '<?= $idea_correction['other_creative_sentence_index']; ?>';
    let other_creative_indexs = JSON.parse(other_creative_sentence_index);
    // console.log(other_creative_indexs);

    $('.other_creative').each(function() {

      for(var i=0; i< other_creative_indexs.length; i++){
        var id = $(this).attr('data-id');
        if (id == other_creative_indexs[i]){
          other_creative_sentense_index.push(other_creative_indexs[i]);

          var chk_ = $(this).attr('style');
          if(chk_ == undefined){
              var text = $(this).text();
              
              $('.other_creative' + id).attr('style', 'background-color: #ffc90e');
              $('.other_creative' + id).append('<span class="tooltip_one tooltip_rs">Metaphor</span>');
          }else{
              $(this).removeAttr('style');
              $(this).find('span').remove();
    ...
    let other_metaphor_text = '<?= json_encode($idea_correction['other_metaphor_text']); ?>';
    $('#other_metaphor_text').val(other_metaphor_text);
    $('.other_creative_sentence_input_box').val(other_metaphor_text);


  });
  $('.other_creative_sentence_save').click(function(){
    $('.other_creative_sentence_preview').show();
    $('#other_metaphor_text').val($('.other_creative_sentence_input_box').val());
  });
  ...
  $('.other_creative_sentence_preview').click(function(){
    ...
    $('.other_creative_sentence_input_box').hide();
    $('.extra_metaphor_box_show').html($('.other_creative_sentence_input_box').val());
    $('.other_creative_sentence_show_box').show();
  });
  ...
  $('.other_creative_sentence_submit').click(function(){
    ...
    for(var j=0;j<right_creative_sentence.length;j++){
      var sentence_no = $('.creative_match_sentence').length;
      var sentence_no = sentence_no+1; 
      var not_chosen_index = right_creative_sentence[j];
      
      if(jQuery.inArray(not_chosen_index, wrong_creative_sentence) == -1) {
        var get_text = $('.other_creative_match'+not_chosen_index).text();

        var sentence = '<p style="position:relative;margin-top: 15px;line-height: 50px" class="creative_match_sentence creative_match_sentence'+not_chosen_index+'"><i class="fa fa-exclamation creative_sentence_wrong'+not_chosen_index+'" style="font-size:22px;color:#00a2e8;position:absolute; top: -5px;left: 30px;"></i><span style="position:absolute;top: -17px;left: 25px;"><b style="margin-left:30px;color:#00a2e8;">(Not Chosen)</b></span><span>'+sentence_no+'.</span>'+get_text+'</p>';
  ...
  $('.other_introduction_button').click(function(){
    ...
    var other_ss_intro = '<?php echo $idea_correction['ss_intro']; ?>';
    var other_ss_intro_parse = JSON.parse(other_ss_intro);

    $('.set_option').each(function(){
      var id = $(this).attr('data-id');

      if(other_ss_intro_parse.ss_intro_option_one && id == 1){
        $('.introduction_set_option_icon'+id).attr('src','assets/images/question_write.png');
        $('#ss_intro_option_one').val(other_ss_intro_parse.ss_intro_option_one);
        $('#ss_intro_option_one_hint').val(other_ss_intro_parse.ss_intro_option_one_hint);
      }
      if(other_ss_intro_parse.ss_intro_option_two && id == 2){
        $('.introduction_set_option_icon'+id).attr('src','assets/images/question_write.png');
        $('#ss_intro_option_two').val(other_ss_intro_parse.ss_intro_option_two);
        $('#ss_intro_option_two_hint').val(other_ss_intro_parse.ss_intro_option_two_hint);
      }
      if(other_ss_intro_parse.ss_intro_option_three && id == 3){
        $('.introduction_set_option_icon'+id).attr('src','assets/images/question_write.png');
        $('#ss_intro_option_three').val(other_ss_intro_parse.ss_intro_option_three);
        $('#ss_intro_option_three_hint').val(other_ss_intro_parse.ss_intro_option_three_hint);
      }
      if(other_ss_intro_parse.ss_intro_option_four && id == 4){
        $('.introduction_set_option_icon'+id).attr('src','assets/images/question_write.png');
        $('#ss_intro_option_four').val(other_ss_intro_parse.ss_intro_option_four);
        $('#ss_intro_option_four_hint').val(other_ss_intro_parse.ss_intro_option_four_hint);
      }
    });
    ...
    $('.ss_intro_option_all').each(function(){
      ...
      if(other_ss_intro_parse.ss_intro_option_one && id == 1)$('.ss_intro_option_description'+id).val(other_ss_intro_parse.ss_intro_option_one);
      if(other_ss_intro_parse.ss_intro_option_two && id == 2)$('.ss_intro_option_description'+id).val(other_ss_intro_parse.ss_intro_option_two);
      if(other_ss_intro_parse.ss_intro_option_three && id == 3)$('.ss_intro_option_description'+id).val(other_ss_intro_parse.ss_intro_option_three);
      if(other_ss_intro_parse.ss_intro_option_four && id == 4)$('.ss_intro_option_description'+id).val(other_ss_intro_parse.ss_intro_option_four);
...
// ===================== Other Body Paragraph ========================
  $('.other_body_paragraph_button').click(function(){
    ...
    var other_ss_body = '<?php echo $idea_correction['ss_body']; ?>';
    var other_ss_body_parse = JSON.parse(other_ss_body);
    console.log(other_ss_body_parse);

    $('.body_para_set_option').each(function(){
      var id = $(this).attr('data-id');

      if(other_ss_body_parse.ss_body_paragraph_option_one && id == 1){
        $('.body_para_set_option_icon'+id).attr('src','assets/images/question_write.png');
        $('#ss_body_paragraph_option_one').val(other_ss_body_parse.ss_body_paragraph_option_one);
        $('#ss_body_paragraph_option_one_hint').val(other_ss_body_parse.ss_body_paragraph_option_one_hint);
      }
      if(other_ss_body_parse.ss_body_paragraph_option_two && id == 2){
        $('.body_para_set_option_icon'+id).attr('src','assets/images/question_write.png');
        $('#ss_body_paragraph_option_two').val(other_ss_body_parse.ss_body_paragraph_option_two);
        $('#ss_body_paragraph_option_two_hint').val(other_ss_body_parse.ss_body_paragraph_option_two_hint);
      }
      if(other_ss_body_parse.ss_body_paragraph_option_three && id == 3){
        $('.body_para_set_option_icon'+id).attr('src','assets/images/question_write.png');
        $('#ss_body_paragraph_option_three').val(other_ss_body_parse.ss_body_paragraph_option_three);
        $('#ss_body_paragraph_option_three_hint').val(other_ss_body_parse.ss_body_paragraph_option_three_hint);
      }
      if(other_ss_body_parse.ss_body_paragraph_option_four && id == 4){
        $('.body_para_set_option_icon'+id).attr('src','assets/images/question_write.png');
        $('#ss_body_paragraph_option_four').val(other_ss_body_parse.ss_body_paragraph_option_four);
        $('#ss_body_paragraph_option_four_hint').val(other_ss_body_parse.ss_body_paragraph_option_four_hint);
      }
    });
    ...
    $('.body_para_option_all').each(function(){
      ...
      if(other_ss_body_parse.ss_body_paragraph_option_one && id == 1)$('.body_para_option_description'+id).val(other_ss_body_parse.ss_body_paragraph_option_one);
      if(other_ss_body_parse.ss_body_paragraph_option_two && id == 2)$('.body_para_option_description'+id).val(other_ss_body_parse.ss_body_paragraph_option_two);
      if(other_ss_body_parse.ss_body_paragraph_option_three && id == 3)$('.body_para_option_description'+id).val(other_ss_body_parse.ss_body_paragraph_option_three);
      if(other_ss_body_parse.ss_body_paragraph_option_four && id == 4)$('.body_para_option_description'+id).val(other_ss_body_parse.ss_body_paragraph_option_four);
    });
...
// ===================== Other Conclusion ========================
  ...
  $('.other_conclution_button').click(function(){
    ...
    var other_ss_conclution = '<?php echo $idea_correction['ss_conclution']; ?>';
    var other_ss_conclution_parse = JSON.parse(other_ss_conclution);

    $('.ss_conclution_set_option').each(function(){
    var id = $(this).attr('data-id');

      if(other_ss_conclution_parse.ss_conclution_option_one && id == 1){
        $('.conclution_set_option_icon'+id).attr('src','assets/images/question_write.png');
        $('#ss_conclution_option_one').val(other_ss_conclution_parse.ss_conclution_option_one);
	      $('#ss_conclution_option_one_hint').val(other_ss_conclution_parse.ss_conclution_option_one_hint);
      }
      if(other_ss_conclution_parse.ss_conclution_option_two && id == 2){
        $('.conclution_set_option_icon'+id).attr('src','assets/images/question_write.png');
        $('#ss_conclution_option_two').val(other_ss_conclution_parse.ss_conclution_option_two);
	      $('#ss_conclution_option_two_hint').val(other_ss_conclution_parse.ss_conclution_option_two_hint);
      }
      if(other_ss_conclution_parse.ss_conclution_option_three && id == 3){
        $('.conclution_set_option_icon'+id).attr('src','assets/images/question_write.png');
        $('#ss_conclution_option_three').val(other_ss_conclution_parse.ss_conclution_option_three);
	      $('#ss_conclution_option_three_hint').val(other_ss_conclution_parse.ss_conclution_option_three_hint);
      }
      if(other_ss_conclution_parse.ss_conclution_option_four && id == 4){
        $('.conclution_set_option_icon'+id).attr('src','assets/images/question_write.png');
        $('#ss_conclution_option_four').val(other_ss_conclution_parse.ss_conclution_option_four);
	      $('#ss_conclution_option_four_hint').val(other_ss_conclution_parse.ss_conclution_option_four_hint);
      }
    ...
    $('.ss_conclution_option_all').each(function(){
      ...
      if(other_ss_conclution_parse.ss_conclution_option_one && id == 1)$('.ss_conclution_option_description'+id).val(other_ss_conclution_parse.ss_conclution_option_one);
      if(other_ss_conclution_parse.ss_conclution_option_two && id == 2)$('.ss_conclution_option_description'+id).val(other_ss_conclution_parse.ss_conclution_option_two);
      if(other_ss_conclution_parse.ss_conclution_option_three && id == 3)$('.ss_conclution_option_description'+id).val(other_ss_conclution_parse.ss_conclution_option_three);
      if(other_ss_conclution_parse.ss_conclution_option_four && id == 4)$('.ss_conclution_option_description'+id).val(other_ss_conclution_parse.ss_conclution_option_four);
    });
  ...
  $(document).on('click','.spelling_remover',function(e){
    e.preventDefault();
    e.stopPropagation();
     var id = $(this).attr('data-id');
     ...
     $(this).remove();
     $('.spelling_prepend'+id).remove();
     
  });
  $('.add_title_text').click(function(){
    $('#title_text_modal').modal('show');
  });
  $('#save_title_text').click(function(){
    var get_text = $('#title_text').val();
    $('#st_title_text').val(get_text);
    $('#title_text_modal').modal('hide');
  });
  $('.add_spelling_text').click(function(){
    $('#spelling_text_modal').modal('show');
  });
  $('#save_spelling_text').click(function(){
    var get_text = $('#spelling_text').val();
    $('#st_spelling_text').val(get_text);
    $('#spelling_text_modal').modal('hide');
  });
  $('.add_creative_text').click(function(){
    $('#creative_text_modal').modal('show');
  });
  $('#save_creative_text').click(function(){
    var get_text = $('#creative_text').val();
    $('#st_creative_text').val(get_text);
    $('#creative_text_modal').modal('hide');
  });
  $('.add_introduction_text').click(function(){
    $('#introduction_text_modal').modal('show');
  });
  $('#save_introduction_text').click(function(){
    var get_text = $('#introduction_text').val();
    $('#st_introduction_text').val(get_text);
    $('#introduction_text_modal').modal('hide');
  });
  $('.add_body_paragraph_text').click(function(){
    $('#body_paragraph_text_modal').modal('show');
  });
  $('#save_body_paragraph_text').click(function(){
    var get_text = $('#body_paragraph_text').val();
    $('#st_body_paragraph_text').val(get_text);
    $('#body_paragraph_text_modal').modal('hide');
  });
  $('.add_conclusion_text').click(function(){
    $('#conclusion_text_modal').modal('show');
  });
  $('#save_conclusion_text').click(function(){
    var get_text = $('#conclusion_text').val();
    $('#st_conclusion_text').val(get_text);
    $('#conclusion_text_modal').modal('hide');
  });


  $(document).on('click','.other_spelling_remover',function(e){
    e.preventDefault();
    e.stopPropagation();
     var id = $(this).attr('data-id');
     var parent = $(this).parent();
     ...
     $(parent).removeAttr('style');
     $(this).remove();
     $('.other_spelling_prepend'+id).remove();
     
  });


  $(function () {
    var $input = $('#misspell_show'); 
    $input.focus() 
    $input.blur(); 
  });

  $('.title_options').click(function(){
     var id = $(this).attr('data-id');
     $('.title_option').attr('style','display:none !important');
     $('.title_option'+id).attr('style','display:block !important');
  });
  $('.title_option').change(function(){
       $('.title_option').attr('style','display:none !important');
       $(this).attr('style','display:block !important');
       var id = $(this).attr('data-id');
       var text = $(this).val();
       $('.title_hint_sort'+id).val(text);
       $(this).attr('style','display:none !important');
  });

  // $('.others_student_idea').click(function(){
  //   $('.title_option').attr('style','display:none !important');
  // });

  // $(".other_title_box").sortable({
  //   delay: 150,
  //   stop: function() {
  //       var allSerial = new Array();
  //       var ideaIds = new Array();
...
// $( ".title_hint_parrent" ).draggable({
//   addClasses: false
// });
// $( ".title_hint_parrent" ).droppable({
//   addClasses: false
// });
